  ...
  return (
    <footer className="bg-stone-900 text-stone-50 py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* Tambahkan sebelum copyright section di Footer */}
        <div>
          ...
          <div className="flex gap-3">
            <a 
              ...
              className="w-10 h-10 bg-stone-800 hover:bg-gradient-to-br hover:from-pink-500 hover:to-purple-600 rounded-lg flex items-center justify-center transition-all transform hover:scale-110"
            >
              <svg className="w-5 h-5 text-stone-400 hover:text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-stone-800 hover:bg-gradient-to-br hover:from-cyan-400 hover:to-pink-500 rounded-lg flex items-center justify-center transition-all transform hover:scale-110"
            >
              <svg className="w-5 h-5 text-stone-400 hover:text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-stone-800 hover:bg-gradient-to-br hover:from-green-500 hover:to-emerald-600 rounded-lg flex items-center justify-center transition-all transform hover:scale-110"
            >
              <svg className="w-5 h-5 text-stone-400 hover:text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-stone-800 hover:bg-gradient-to-br hover:from-orange-500 hover:to-red-600 rounded-lg flex items-center justify-center transition-all transform hover:scale-110"
            >
              <svg className="w-5 h-5 text-stone-400 hover:text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className=" mt-4 border-t border-stone-800 pt-8 text-center text-stone-400 text-sm">
